        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="glass-panel rounded-lg p-8 crt-effect">
            {!gameStarted ? (
              <>
                ...
                <div className="flex justify-center">
                  <button 
                    ...
                    className="retro-button px-8 py-4 text-lg animate-pulse-subtle"
                  >
                    START GAME
                  </button>
                </div>
              ...
              <div className="bg-background rounded-lg border-2 border-secondary p-4 pixel-shadow min-h-[400px] md:min-h-[500px]">
                <GameScenario onRestart={handleRestartGame} />
              </div>
            )}
          </div>
        </div>
